...
<!-- Mirrored from templates.thememodern.com/compact/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Jan 2017 04:11:10 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    <div class="eder/images-preloader" id="images-preloader">
        <div class="spinner">
    ...
    <div id="wrapper">
                    ...
                    <div class="row">                    
                        <div class="col-md-12">
                            ...
                            <div id="logo" class="pull-left">                            
                                <a href="index-2.html">
                                    <img src="eder/images/logo.png" alt="" class="logo">
                                </a>
                            </div>
                            <!-- logo close -->
                                ...
                                <ul class="clearfix">
                                        ...
                                        <li><a href="#">Features</a>
                                            <ul>
                                                ...
                                                <li><a href="#">Sub Headers</a>
                                                    <ul>
                                                        <li><a href="#">Sub Header 1</a></li>
                                                        <li><a href="#">Sub Header 2</a></li>
                                                        <li><a href="#">Sub Header 3</a></li>
                                                        <li><a href="#">Sub Header 4</a></li>
                                                    </ul>
                                                </li> 
                                        ...
                                        <li><a href="projects.html">Portfolios</a>
                                            <ul>
                                                ...
                                                <li><a href="#">Portfolio 5 Columns</a></li>
                                                <li><a href="#">Single Project</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Shop</a>
                                            <ul>
                                                <li><a href="#">Online Store Catalog</a></li>
                                                <li><a href="#">Online Store Shopping Cart</a></li>
                                                <li><a href="#">Online Store Checkout</a></li>
                                                <li><a href="#">Single Store Product</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">Contact Us</a>
                                            <ul>
                                                <li><a href="#">Contact Us 01</a></li>
                                                <li><a href="#">Contact Us 02</a></li>
                                                <li><a href="#">Contact Us 03</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                            </nav>
                                    ...
                                    <div class="dropdown-menu top_cart_list_product">
                                        <ul class="cart_list product_list_widget clearfix">
                                            <li class="mini_cart_item">
                                                <div class="img-thumb">
                                                    <img alt="" class="attachment-shop_thumbnail" src="eder/images/shop/thumb/product-thumb-1.jpg">
                                                </div>
                                            ...
                                            <li class="mini_cart_item">
                                                <div class="img-thumb">
                                                    <img alt="" class="attachment-shop_thumbnail" src="eder/images/shop/thumb/product-thumb-2.jpg">
                                                </div>
                                                <div class="product-detail">
                                                    <a class="remove" href="#"><i class="fa fa-times"></i></a>
                                            ...
                                            <li class="mini_cart_item">
                                                <div class="img-thumb">
                                                    <img alt="" class="attachment-shop_thumbnail" src="eder/images/shop/thumb/product-thumb-3.jpg">
                                                </div>
                                                <div class="product-detail">
                                                    <a class="remove" href="#"><i class="fa fa-times"></i></a>
                                                    <a href="#">Bed Wood</a>                                                                
        ...
        <div class="navright-button hidden-sm">
            <div class="compact-menu-canvas" id="offcanvas-menu">
                ...
                <nav>
                  <ul class="clearfix">
                        <li><a href="index-2.html">Home menu</a></li>
                ...
                <div class="row"> 
                        ...
                        <div class="blog-single">
                            ...
                            <article>
                                <div class="post-media">
                                    <img src="eder/images/news/blog-details.jpg" class="img-responsive">                                    
                                </div>
                                <div class="post-content">
                                    <div class="post-title">
                                        <h1>Mobile UX And User Expectations</h1>
                                    </div>
                                    ...
                                    <div class="post-entry">
                                        ...
                                        <cite>Steve Jobs &ndash; Apple Worldwide Developers’ Conference, 1997</cite></p>
                                        </blockquote>  
                                        ...
                                        <ul class="list-style-1">
                                            <li>Vestibulum nibh purus, porta non molestie eget, laoreet orci. </li>
                                            <li>Nam malesuada dolor eget aliquet rhoncus</li>
                                            <li>Sed feugiat vestibulum mauris, at ultricies eros feugiat feugiat</li>
                                            <li>Nam justo ipsum, sagittis sed hendrerit ac rhoncus</li>
                                            <li>Aenean et orci eget neque faucibus iaculis feugiat sed sapien.</li>
                                        </ul>                                                                  
                                    </div>
                                    ...
                                    <nav class="navigation post-navigation">                                        
                                        <div class="nav-links">
                                            <div class="nav-previous">
                                                <a href="#">
                                                    <span class="meta-nav"><i class="fa fa-angle-double-left"></i> Previous</span> 
                                                    <span class="post-title">10 Ways To Design For The Human Brain</span>
                                                </a>
                                            </div>
                                            <div class="nav-next">
                                                <a href="#">
                                                    <span class="meta-nav">Next <i class="fa fa-angle-double-right"></i></span>
                                                    <span class="post-title">Mobile UX And User Expectations</span>
                                                </a>
                                            </div>
                                        </div>
                                    </nav>
                                        ...
                                        <div class="comment-respond" id="respond">
                                            ...
                                            <form class="comment-form" id="commentform" method="post" action="#">                                                    
                                                ...
                                                <p class="comment-form-comment">
                                                    <textarea rows="8" cols="45" placeholder="Message*" name="comment" id="comment"></textarea>
                                                </p>
                    ...
                    <div class="col-md-3">
                        <div class="main-sidebar">
                            ...
                            <aside class="widget widget_text">                                         
                                <div class="textwidget">
                                    <a href="#"><img src="eder/images/news/ads.jpg" alt="" class="img-responsive"></a>                                
                                </div>
                            </aside>
                        ...
                        <div class="col-md-3">
                            <div class="compact-widget">                                                
                                <div class="widget-inner">
                                    <img class="logo-footer" src="eder/images/logo-footer.png" alt="compact company">
...
<!-- Mirrored from templates.thememodern.com/compact/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Jan 2017 04:11:14 GMT -->
</html>

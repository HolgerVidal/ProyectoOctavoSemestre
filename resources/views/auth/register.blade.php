            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="r_titulo">Datos Peronales</h4>
                            </div>
                        </div>
                        <div id="datos_persona" class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="fecha_nacimiento" type="date" style="height: 35px;" class="form-control" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" required >
                            </div>
